...
export function createBasketItem({
  ...
  const basketItem = {
    ...
    product_image: variant.image && variant.image.url ? variant.image.url : undefined,
    ...
    metadata,
    subscription,
    placeholder_image: variant.placeholder_image ? variant.placeholder_image : undefined
  };
